...
train = pd.read_pickle(path + 'cascade_train.pkl.gz')
valid = pd.read_pickle(path + 'cascade_valid.pkl.gz')
...
class RBFSequence(GraphSequence):
    def process_data(self, batch_data):
        ...
        #print(batch_data)
        #print(batch_data["bond"])
        #print(batch_data["distance"])
        #print(batch_data["n_atom"])
        #print(batch_data["n_bond"])
        #print(batch_data["distance"])
        batch_data['distance_rbf'] = rbf_expansion(batch_data['distance'])
        #print(batch_data["distance_rbf"])
        ...
        print(batch_data)
        print(batch_data["atom"].size)
        print(batch_data["distance_rbf"].shape)
        print(batch_data["connectivity"].shape)
        print(batch_data["bond"].shape)
        return batch_data

with open(path + 'cascade_processed_inputs.p', 'rb') as f:
