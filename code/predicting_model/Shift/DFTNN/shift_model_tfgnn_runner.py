...
def set_initial_node_state(node_set, *, node_set_name):
    ...
    print(atom_num_embedding)
    print(chiral_tag_embedding)
    print(hybridization_embedding)
...
if __name__ == "__main__":
    ...
    train_ds_provider = runner.TFRecordDatasetProvider(filenames=["data/own_data/easy_train.tfrecords"])
    test_ds_provider = runner.TFRecordDatasetProvider(filenames=["data/own_data/easy_test.tfrecords"])
    valid_ds_provider = runner.TFRecordDatasetProvider(filenames=["data/own_data/easy_valid.tfrecords"])
    ...
    trainer = runner.KerasTrainer(
        ...
        model_dir=path + "tmp/gnn_model/simple_model/",
